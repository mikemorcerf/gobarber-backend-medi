...
describe('CreateAppointment', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    appointmentDate = new Date(2020, 4, 11, 12);
                    return [4 /*yield*/, createAppointment.execute({
    ...
    it('should not be able to create an appointment at a past date', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest.spyOn(Date, 'now').mockImplementationOnce(function () {
    ...
    it('should not be able to create an appointment where customer_id is the same as provider_id', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest.spyOn(Date, 'now').mockImplementationOnce(function () {
    ...
    it('should not be able to create an appointment before 8am or after 5pm', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    jest.spyOn(Date, 'now').mockImplementationOnce(function () {
    ...
    it('should be able to create a notification to provider upon appointment has been scheduled', function () { return __awaiter(void 0, void 0, void 0, function () {
        var createNotification;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    createNotification = jest.spyOn(fakeNotificationsRepository, 'create');
                    return [4 /*yield*/, createAppointment.execute({
                            date: new Date(2020, 4, 10, 12),
                            provider_id: 'provider_id',
                            user_id: 'customer_id',
