...
var ListProviderMonthAvailabilityService = /** @class */ (function () {
    ...
    ListProviderMonthAvailabilityService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointmentsInMonthFromProvider, numberOfDaysInMonth, eachDayArray, currentDate, availabilityOfDaysInMonth;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        appointmentsInMonthFromProvider = _b.sent();
                        ...
                        availabilityOfDaysInMonth = eachDayArray.map(function (day) {
                            var appointmentsInDay = appointmentsInMonthFromProvider.filter(function (appointment) {
                                return date_fns_1.getDate(appointment.date) === day;
                            });
                            var compareDate = new Date(year, month - 1, day, 17, 1, 0);
                            return {
                                day: day,
                                available: appointmentsInDay.length < 10 && date_fns_1.isAfter(compareDate, currentDate),
                            };
                        });
                        return [2 /*return*/, availabilityOfDaysInMonth];
                }
            });
        });
    };
