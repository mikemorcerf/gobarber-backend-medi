...
var ListProviderDayAvailabilityService = /** @class */ (function () {
    ...
    ListProviderDayAvailabilityService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointmentsInDayFromProvider, firstAppointmentHourOfDay, eachHourArray, currentDate, availabilityOfHoursInDay;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        appointmentsInDayFromProvider = _b.sent();
                        firstAppointmentHourOfDay = 8;
                        eachHourArray = Array.from({ length: 10 }, function (_, index) { return index + firstAppointmentHourOfDay; });
                        currentDate = new Date(Date.now());
                        availabilityOfHoursInDay = eachHourArray.map(function (hour) {
                            var hasAppointmentInHour = appointmentsInDayFromProvider.find(function (appointment) { return date_fns_1.getHours(appointment.date) === hour; });
                        ...
                        return [2 /*return*/, availabilityOfHoursInDay];
                }
            });
        });
    };
