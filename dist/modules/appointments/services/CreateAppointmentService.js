...
var CreateAppointmentService = /** @class */ (function () {
    ...
    CreateAppointmentService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointmentDate, findAppointmentInSameDate, appointment, formattedDate;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (user_id === provider_id) {
                            throw new AppError_1.default('You cannot create an appointment with yourself');
                        }
                        ...
                        if (date_fns_1.getHours(appointmentDate) < 8 || date_fns_1.getHours(appointmentDate) > 17) {
                            throw new AppError_1.default('Cannot create appointments before 8am or past 5pm');
                        }
                        if (date_fns_1.isBefore(appointmentDate, Date.now())) {
                            throw new AppError_1.default('Appointments at a time past the current time cannot be created');
                        }
                    ...
                    case 2:
                        appointment = _b.sent();
                        formattedDate = date_fns_1.format(appointmentDate, "MMMM Mo 'at' HH:mm'h'");
                    ...
                    case 3:
                        _b.sent();
                        this.cacheProvider.invalidate("provider-appointments:" + provider_id + ":" + date_fns_1.format(appointmentDate, 'yyyy-M-d'));
