...
var AppointmentsRepository = /** @class */ (function () {
    ...
    AppointmentsRepository.prototype.findAllInMonthFromProvider = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointmentsInMonthFromProvider;
            return __generator(this, function (_b) {
                appointmentsInMonthFromProvider = this.appointments.filter(function (appointment) {
                ...
                return [2 /*return*/, appointmentsInMonthFromProvider];
            });
        });
    };
    AppointmentsRepository.prototype.findAllInDayFromProvider = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var appointmentsInDayFromProvider;
            return __generator(this, function (_b) {
                appointmentsInDayFromProvider = this.appointments.filter(function (appointment) {
                    return (appointment.provider_id === provider_id &&
                        date_fns_1.getMonth(appointment.date) + 1 === month &&
                        date_fns_1.getYear(appointment.date) === year &&
                        date_fns_1.getDate(appointment.date) === day);
                });
                return [2 /*return*/, appointmentsInDayFromProvider];
            });
        });
    };
